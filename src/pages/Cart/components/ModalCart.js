...
export const ModalCart = ({setShowModal}) => {

    const navigate = useNavigate();
    

  return (
    <div id="popup-modal" tabIndex="-1" className="overflow-y-auto bg-transparent overflow-x-hidden fixed top-0 right-0 left-0 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div className="relative p-4 mx-auto w-full max-w-md h-full">
            <div className="relative  bg-white my-[50%] rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-4 md:p-5 text-center">
                    ...
                    <h2 className="mb-2 text-lg font-semibold text-black dark:text-white">Requerimientos para adquirir nuestros cursos:</h2>
                    <ul className="max-w-md space-y-1 text-black list-disc list-inside dark:text-white">
                        <li>
                            Debes registrarte en nuestra plataforma.
                        </li>
                        <li>
                            Debes iniciar sesión para registrarte en los cursos que deseas adquirir
                        </li>
                        <li>
                            Regresas nuevamente al proceso de compra y listo.!!!
                        </li>
                    </ul>



                    <button onClick={()=>{setShowModal(false);navigate('/register')}} data-modal-hide="popup-modal" type="button" className="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Ok</button>
