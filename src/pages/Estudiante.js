...
export const Estudiante = () => {
  ...
  return (
    <div className="relative">
        ...
        <div id="drawer-navigation" className={`absolute top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform ${showBar ? '-translate-x-full':''} sm:translate-x-0  bg-white dark:bg-gray-800 border-e-2 border border-b-2 rounded-lg border-slate-400 mt-4`} tabIndex="-1" aria-labelledby="drawer-navigation-label" >
            ...
            <div className="py-4 overflow-y-auto">
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        ...
                        <span className="ms-3">Mis Cursos</span>
                        </Link>
                    </li>
                    <li>
                        <Link to='/' className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
