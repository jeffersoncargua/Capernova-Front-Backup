        ...
        <div id="sidebar-multi-level-sidebar" className={`absolute top-0 left-0 z-40 w-64 h-screen transition-transform ${showBar? '-translate-x-full':''} sm:translate-x-0`} aria-label="Sidebar">
            ...
            <div className="overflow-y-auto overflow-x-hidden bg-gradient-to-r from-indigo-100 to-blue-500 dark:bg-gray-800 rounded-lg border-2 border-zinc-600 shadow-md shadow-zinc-700 dark:shadow-zinc-50">
                ...
                <ul className="space-y-2 font-medium">
                    <li>
                        <span className="ms-3 whitespace-nowrap w-full text-xl dark:text-white flex items-center p-2 text-gray-900">Secretaria</span>
                    </li>   
                    {/*<li>
                    ...
                    <li>
                        <button onClick={()=> {setShowEstudiantes(true);setShowCursos(false);setShowVentas(false)}} className="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <span className=" ms-3 whitespace-nowrap">Estudiantes</span>
                        </button>
                    </li>             
                    <li>
                        <button onClick={()=> {setShowEstudiantes(false);setShowCursos(true);setShowVentas(false)}} className="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <span className="ms-3 whitespace-nowrap">Cursos</span>
                        </button>
                    </li>
                    <li>
                        <button onClick={()=> {setShowEstudiantes(false);setShowCursos(false);setShowVentas(true)}} className="w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
