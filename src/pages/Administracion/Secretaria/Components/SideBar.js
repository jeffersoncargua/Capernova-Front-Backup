...
export const SideBar = ({setShowEstudiantes,setShowCursos,setShowVentas}) => {
  ...
  return (
    <div className="relative mt-4">
        ...
        <div id="sidebar-multi-level-sidebar" className={`absolute top-0 left-0 z-40 w-64 p-4 transition-transform ${showBar? '-translate-x-full':''} sm:translate-x-0 bg-slate-800 dark:bg-gray-800 border-e-2 border border-b-2 rounded-lg border-slate-400 mt-4`} tabIndex="-1" aria-labelledby="drawer-navigation-label">
