...
import { UpdateVenta } from "../../../../apiServices/SecretaryServices/SecretaryServices";
	...
	return (
		<div>
			...
			{showModalVentaDetail && (
				<VentaDetails
					showModalVentaDetail={showModalVentaDetail}
					setShowModalVentaDetail={setShowModalVentaDetail}
					venta={venta}
					setVenta={setVenta}
				/>
			)}
			...
			<section className="">
				<div className="mx-auto max-w-screen-xl px-4 lg:px-12">
					...
					<div className="group text-black dark:text-white">
						<DownloadTableExcel
							filename={`Reporte-Capernova-${new Date().toLocaleDateString()}`}
							sheet="reporte"
						...
						>
							...
							>
								<svg
									...
									fill="currentColor"
									className="bi bi-table w-5 h-5 me-2.5"
									viewBox="0 0 16 16"
								>
