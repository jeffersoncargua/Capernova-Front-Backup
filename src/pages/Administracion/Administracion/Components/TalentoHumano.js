...
export const TalentoHumano = ({
	...
	useEffect(() => {
		const fetchTalento = async () => {
			try {
				var resultFromApi = await GetTalent(searchRole, searchUser);
	...
	return (
		<div className="w-[95%] mx-auto">
			{showModalTalento && (
				<ModalTalento
					showModalTalento={showModalTalento}
					setShowModalTalento={setShowModalTalento}
					talento={talento}
					setTalento={setTalento}
					talentoList={talentoList}
					setTalentoList={setTalentoList}
					...
					<div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
						<div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
								...
								<form className="flex items-center mt-2">
									...
									<div className="relative w-full">
										...
										<input
											...
											placeholder="Busca por el nombre o apellido"
											required=""
											ref={refSearch}
										/>
									</div>
							...
							<div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
								<button
									onClick={() => {
										setShowModalTalento(!showModalTalento);
										setTalento({});
										setResponse({});
									}}
									type="button"
			...
			<div className="flex justify-around items-center p-3 sm:p-5">
				<div className="group dark:text-white">
					<p>
						...
						de <span>{talentoList?.length}</span> resultados
					</p>
				</div>
