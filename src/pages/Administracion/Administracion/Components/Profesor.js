	...
	return (
		<div className="w-[90%] mx-auto">
			...
			<div className="mb-2 group dark:text-white">
				<label className="mb-2 font-medium" htmlFor="titulo">
					Nombre: {profesor.name}{" "}
				</label>
			</div>
			<div className="mb-2 group dark:text-white">
				<label className="mb-2 font-medium" htmlFor="titulo">
					Apellido: {profesor.lastName}
				</label>
			</div>
			...
			<h1 className="text-center mb-5 font-medium text-xl dark:text-white">
				Cursos que se dicta:
			</h1>
