...
import {
	CreateCategory,
	UpdateCategory,
} from "../../../../apiServices/ManagmentServices/ManagmentCategoriesServices";

export const ModalAreaCategoria = ({
	showModalAreaCategoria,
				...
				<div className="relative p-4 mx-auto w-full max-w-md max-h-full">
					...
					<div className="relative bg-white my-[10%] rounded-lg shadow dark:bg-gray-700 mb-14">
						...
						<div className="flex items-center justify-between p-4 md:p-5 dark:border-gray-600">
							...
							<button
								onClick={() => setShowModalAreaCategoria(false)}
								type="button"
						...
						<form
							...
							onSubmit={categoria.id ? handleSubmitEdit : handleSubmitAdd}
						>
