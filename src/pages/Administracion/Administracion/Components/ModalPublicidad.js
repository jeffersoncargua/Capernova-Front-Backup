...
import {
	CreateMarketing,
	UpdateMarketing,
} from "../../../../apiServices/GeneralServices";

export const ModalPublicidad = ({
	showModal,
	setShowModal,
	publicidad,
	fetchPublicidad,
				...
				<div className="relative p-4 mx-auto w-full max-w-md max-h-full">
					...
					<div className="relative bg-white my-[10%] rounded-lg shadow dark:bg-gray-700 mb-14">
						...
						<form
							...
							onSubmit={publicidad.id ? handleSubmitEdit : handleSubmitAdd}
						>
							<div className="grid gap-4 mb-4 grid-cols-2">
								<div className="col-span-2">
									...
									<input
										...
										required
										ref={refTitulo}
										defaultValue={publicidad.titulo || ""}
									/>
								</div>
								<div className="col-span-2">
									<label
									...
									<textarea
										...
										required
										ref={refImageUrl}
										defaultValue={publicidad.imageUrl || ""}
									></textarea>
								</div>
							</div>
							{showButtonLoading ? (
