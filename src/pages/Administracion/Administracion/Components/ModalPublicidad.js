...
export const ModalPublicidad = ({showModal,setShowModal,publicidad,setResponse}) => {
  ...
  return (
    <div>
        {/*<!-- Main modal -->*/}
        <div id="crud-modal" tabIndex='-1' aria-hidden="true" className={`${showModal? '' :'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
                ...
                <div className="relative bg-white my-[30%] rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                            {publicidad.id ? 'Editar Publicidad':'Agregar Nueva Publicidad'}
                        </h3>
                        <button onClick={()=>{setShowModal(false);setResponse({})}} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
