export const ModalSuccessAssigment = ({
		...
		>
			<div className="relative p-4 mx-auto w-full max-w-md h-full">
				<div className="relative bg-white my-[50%] rounded-lg shadow dark:bg-gray-700">
					{!response.isSuccess && (
						<button
							onClick={() => setShowModalAssigment(false)}
							type="button"
					...
					<div className="p-4 md:p-5 text-center">
						{response.isSuccess ? (
							<svg
								...
								height="16"
								fill="currentColor"
								className={`bi bi-check-circle mx-auto mb-4 text-green-400 w-12 h-12 dark:text-green-400`}
								viewBox="0 0 16 16"
							>
