...
export {ModalPublicidad} from './ModalPublicidad';
export {ModalDelete} from './ModalDelete';
export {ModalCourse} from './ModalCourse';
export {ModalDeleteCurso} from './ModalDeleteCurso';
export {ModalCapitulo} from './ModalCapitulo';
export {ModalDeleteCapitulo} from './ModalDeleteCapitulo';
