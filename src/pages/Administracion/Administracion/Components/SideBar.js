...
export const SideBar = ({setShowPublicidad,setShowCursos,setShowVentas,setShowPedidos,setShowVideos,setShowTalento,setShowProfesor,setShowProductos,setResponse,setShowAreaCategoria,setShowInscripcion}) => {
        ...
        <div id="sidebar-multi-level-sidebar" className={`absolute top-0 left-0 z-40 w-[95%] min-[350px]:w-56 p-4 flex overflow-y-auto  transition-transform ${showBar? '-translate-x-full':''} sm:translate-x-0 bg-slate-800 dark:bg-gray-800 border border-b-2 rounded-lg border-slate-400 mt-4`} tabIndex='-1' aria-label="Sidebar">
            ...
            <div className="overflow-y-auto ">
                ...
                <ul className="space-y-2 text-sm font-small">                      
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(false);setShowVentas(false);setShowPedidos(false);setShowVideos(false);setShowTalento(false);setShowProfesor(false);setShowProductos(false);setShowAreaCategoria(true);setShowInscripcion(false);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(true);setShowVentas(false);setShowPedidos(false);setShowVideos(false);setShowTalento(false);setShowProfesor(false);setShowProductos(false);setShowAreaCategoria(false);setShowInscripcion(false);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-journal-bookmark w-5 h-5 text-gray-500 transition duration-75 group-hover:text-black dark:group-hover:text-white" viewBox="0 0 16 16">
                                <path fillRule="evenodd" d="M6 8V1h1v6.117L8.743 6.07a.5.5 0 0 1 .514 0L11 7.117V1h1v7a.5.5 0 0 1-.757.429L9 7.083 6.757 8.43A.5.5 0 0 1 6 8"/>
                                <path d="M3 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-1h1v1a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v1H1V2a2 2 0 0 1 2-2"/>
                                <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1z"/>
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(false);setShowVentas(true);setShowPedidos(false);setShowVideos(false);setShowTalento(false);setShowProfesor(false);setShowProductos(false);setShowAreaCategoria(false);setShowInscripcion(false);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(false);setShowVentas(false);setShowPedidos(true);setShowVideos(false);setShowTalento(false);setShowProfesor(false);setShowProductos(false);setShowAreaCategoria(false);setShowInscripcion(false);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">                            
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(false);setShowVentas(false);setShowPedidos(false);setShowVideos(false);setShowTalento(true);setShowProfesor(false);setShowProductos(false);setShowAreaCategoria(false);setShowInscripcion(false);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(false);setShowVentas(false);setShowPedidos(false);setShowVideos(false);setShowTalento(false);setShowProfesor(false);setShowProductos(false);setShowAreaCategoria(false);setShowInscripcion(true);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">                            
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-people-fill w-5 h-5 text-gray-500 transition duration-75 group-hover:text-black dark:group-hover:text-white" viewBox="0 0 16 16">
