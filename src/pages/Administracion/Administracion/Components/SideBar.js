...
export const SideBar = ({setShowPublicidad,setShowCursos,setShowVentas,setShowVideos,setShowTalento,setShowProfesor,setShowProductos,setResponse}) => {
        ...
        <div id="sidebar-multi-level-sidebar" className={`absolute top-0 left-0 z-40 w-56 p-4 flex overflow-y-auto  transition-transform ${showBar? '-translate-x-full':''} sm:translate-x-0 bg-slate-800 dark:bg-gray-800 border border-b-2 rounded-lg border-slate-400 mt-4`} tabIndex='-1' aria-label="Sidebar">
            ...
            <div className="overflow-y-auto ">
                ...
                <ul className="space-y-2 text-sm font-small">                      
                    <li>
                        <button onClick={()=> {setShowPublicidad(true);setShowCursos(false);setShowVentas(false);setShowVideos(false);setShowTalento(false);setShowProfesor(false);setShowProductos(false);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(true);setShowVentas(false);setShowVideos(false);setShowTalento(false);setShowProfesor(false);setShowProductos(false);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(false);setShowVentas(false);setShowVideos(false);setShowTalento(false);setShowProfesor(false);setShowProductos(true);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(false);setShowVentas(true);setShowVideos(false);setShowTalento(false);setShowProfesor(false);setShowProductos(false);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={()=> {setShowPublicidad(false);setShowCursos(false);setShowVentas(false);setShowVideos(false);setShowTalento(true);setShowProfesor(false);setResponse({})}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
