...
import { UpdatePedido } from "../../../../apiServices/ManagmentServices/ManagmentVentas";
			...
			>
				<div className="relative p-4 mx-auto w-full max-w-2xl max-h-full dark:border-gray-600 mb-14">
					...
					<div className="relative bg-white my-[4%] rounded-lg shadow dark:bg-gray-700">
						...
						<div
							translate="no"
							className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden mb-10"
						>
