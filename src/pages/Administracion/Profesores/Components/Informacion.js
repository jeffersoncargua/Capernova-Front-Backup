    ...
    <div className='w-[95%] mx-auto mb-10'>
      ...
      <form onSubmit={handleSubmit} encType='multipart/form-data' className={`${!showLoading ? '':'hidden'}`} >
        <div className='w-[95%] mx-auto flex items-center justify-center flex-col'>
          ...
          <div className='z-10 -mt-28 w-full border-2 border-gray-300 shadow-lg rounded-xl bg-slate-50 '>
            <div className='p-6 mt-24 flex flex-col gap-y-3'>
              ...
              <div className='w-[95%] relative group' >
                ...
                <textarea className={`w-full ${!enableBiography ? 'border-0 bg-transparent':'border-1 border-blue-300 bg-blue-200'} rounded-lg p-3 text-justify`} rows='8'  disabled={enableBiography} name="biography" id="biography" defaultValue={profesor.biografy} placeholder='Ingrese información sobre su biografía...' ref={refBiography}></textarea>
