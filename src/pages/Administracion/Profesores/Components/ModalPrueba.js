...
export const ModalPrueba = ({showModalPrueba,setShowModalPrueba,prueba,setPrueba, curso, setResponse/*pruebas,setPruebas*/}) => {
  ...
  return (
    <div>
        {/*<!-- Main modal -->*/}
        <div id="crud-modal" tabIndex='-1' className={`${showModalPrueba? '' :'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] h-full bg-gray-700/[0.6]`}>
                    ...
                    <form className="p-4 md:p-5" onSubmit={prueba.id ?  handleSubmitEdit : handleSubmitAdd} >
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div className="col-span-2">
                                ...
                                <input type="text" name="titulo" id="titulo" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Escribe el titulo de la prueba" required ref={refTitulo} defaultValue={prueba.titulo || ''} />
                            </div>
                            <div className="col-span-2">
                                <label htmlFor="detalle" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Detalle</label>                                
                                <textarea id="detalle" name='detalle' rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escribe la descripción de la prueba aquí" required  defaultValue={prueba.detalle} ref={refDetalle}></textarea>                    
                            </div>
                            <div className="col-span-2">
                                <label htmlFor="test" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Test</label>
                                <input type="text" name="test" id="test" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Coloca la URL de la prueba aquí" required ref={refTest} defaultValue={prueba.test || ''} />
                            </div> 
