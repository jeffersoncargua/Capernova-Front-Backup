...
export const ModalCapitulo = ({showModalCapitulo,setShowModalCapitulo,capitulo, setCapitulo,capitulos, setCapitulos}) => {
  ...
  return (
    <div>
        {/*<!-- Main modal -->*/}
        <div id="crud-modal" tabIndex='-1' aria-hidden="true" className={`${showModalCapitulo? '' :'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
                ...
                <div className="relative bg-white my-[30%] rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                            {capitulo.Codigo ? 'Editar Capítulo':'Agregar Capítulo'}
                        </h3>
                    ...
                    {/*<!-- Modal body -->*/}
                    <form className="p-4 md:p-5" onSubmit={capitulo.Codigo ?  handleSubmitEdit : handleSubmitAdd} >
