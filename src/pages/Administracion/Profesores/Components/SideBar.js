...
export const SideBar = ({setShowInformacion,setShowCursos,setShowVideos,setShowEstudiantes,setShowDeberes,setShowPruebas,setResponse}) => {
  ...
  return (
    <div className="relative mt-4">
        ...
        <div id="sidebar-multi-level-sidebar" className={`absolute top-0 left-0 z-40 w-56 p-4 flex overflow-y-auto transition-transform ${!showBar? '-translate-x-full':''} md:translate-x-0 bg-slate-800 dark:bg-gray-800 border border-b-2 rounded-lg border-slate-400 mt-4 `} tabIndex='-1' aria-label="Sidebar">
