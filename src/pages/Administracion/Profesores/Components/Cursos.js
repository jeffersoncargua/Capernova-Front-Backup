										...
										currentDataDisplayed.map((item) => (
											...
											>
												<td className="px-4 py-3">
													<img
														src={`https://lh3.googleusercontent.com/d/${item.imagenUrl}`}
												...
												<td className="px-4 py-3">
													<div className="py-1 flex justify-start">
														...
														<button
															...
															className="flex items-center justify-center py-2 px-4 text-sm text-gray-900 hover:text-white bg-violet-300 hover:bg-violet-400 rounded-lg mr-2"
														>
															<svg
																className="me-1 -ms-1 w-5 h-5"
																fill="currentColor"
			...
			<div className="flex justify-around items-center p-3 sm:p-5">
				<div className="group dark:text-white">
					<p>
						...
						de <span>{cursoList?.length}</span> resultados
					</p>
				</div>
