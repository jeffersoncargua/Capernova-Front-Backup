	...
	return (
		<div className="w-[95%] mx-auto flex  flex-col items-align mt-10 group text-black dark:text-white space-y-8 mb-10">
			<h1 className="self-center text-3xl md:text-5xl text-center">
				Se ha presentado un error en nuestros servidores!!
			</h1>
			<h1 className="self-center text-2xl md:text-4xl text-center">
				Por favor, espera mientras nuestros técnicos lo resuelven!
			</h1>
			<h1 className="self-center text-2xl md:text-4xl">Muchas Gracias!!!</h1>
			<div className="w-full flex justify-center">
				<img
					src={`https://drive.google.com/thumbnail?id=1xYLAnLc4dfMJC281J0VTKDc38JI-plF9`}
