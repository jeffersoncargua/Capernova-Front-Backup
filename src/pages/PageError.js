  ...
  return (
    <div className="w-[95%] mx-auto flex  flex-col items-align mt-10 group text-black dark:text-white space-y-8 mb-10">
        ...
        <div className="w-full flex justify-center">
            <img src={`https://drive.google.com/thumbnail?id=1xYLAnLc4dfMJC281J0VTKDc38JI-plF9`} alt="aqui va la imagen" />
        </div>
        <div className="self-center">
            <button onClick={()=>navigate('/')} className="flex items-align rounded-lg px-3 py-2.5 text-black dark:text-white bg-blue-500 hover:bg-blue-600 dark:bg-blue-700 hover:dark:bg-blue-800">
                Regresar Página de Inicio
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-house-door-fill w-5 h-5 ms-2 " viewBox="0 0 16 16">
