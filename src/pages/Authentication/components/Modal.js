...
export const Modal = ({
	response,
	setShowModal,
	tipo /*,messagePassword,setMessagePassword*/,
}) => {
				...
				<div className="relative bg-white my-[20%] rounded-lg shadow dark:bg-gray-700">
					...
					<div className="p-4 md:p-5 text-center">
							...
							<>
								...
								<ul className="max-w-md space-y-1 text-start text-black list-disc list-inside dark:text-white">
									...
									<li>
										...
										(!@#) un número y letra mayúscula.
									</li>
									<li>Ingresar contraseñas iguales para su verificación.</li>
								</ul>
							</>
						)}
						...
						{response.isSuccess ? (
							...
							<button
								onClick={() => {
									setShowModal(false); /*;setMessagePassword('')*/
								}}
								data-modal-hide="popup-modal"
								type="button"
								className="py-2.5 px-5 ms-3 text-sm font-medium text-black focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 mt-4"
