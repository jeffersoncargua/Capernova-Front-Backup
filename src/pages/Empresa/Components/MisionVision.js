        ...
        <div className="my-[10px] w-full md:w-1/2 dark:text-white  md:float-left">
          ...
          <ul className="text-sm space-y-4 text-left text-black dark:text-white text-justify group">
              <li className="flex items-center space-x-3 rtl:space-x-reverse">
                  ...
                  <span>Brindar programas de capacitación y desarrollo profesional de alta calidad que permitan a los participantes mejorar sus habilidades y conocimientos.</span>
              </li>
              <li className="flex items-center space-x-3 rtl:space-x-reverse">
                  <svg className="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                  </svg>
                  <span>Crear un entorno de aprendizaje interactivo y colaborativo que facilite la aplicación práctica de lo aprendido.</span>
              </li>
              <li className="flex items-center space-x-3 rtl:space-x-reverse">
                  <svg className="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                  </svg>
                  <span>Mantenerse a la vanguardia de las tendencias y mejores prácticas en nuestras áreas aplicadas, para ofrecer servicios relevantes y efectivos.</span>
              </li>
              <li className="flex items-center space-x-3 rtl:space-x-reverse">
                  <svg className="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                  </svg>
                  <span>Contribuir al crecimiento y desarrollo profesional de la comunidad, a través de programas de capacitación accesibles y asequibles.</span>
              </li>
        ...
        <div className="my-[10px] w-full md:w-1/2 dark:text-white  md:float-right">
          ...
          <ul className="text-sm space-y-4 text-left text-black dark:text-white text-justify group">
              <li className="flex items-center space-x-3 rtl:space-x-reverse">
                  ...
                  <span>Ser reconocido como un líder en la entrega de soluciones de capacitación y desarrollo profesional de excelencia.</span>
              </li>
              <li className="flex items-center space-x-3 rtl:space-x-reverse">
                  <svg className="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                  </svg>
                  <span>Fomentar una cultura de aprendizaje continuo que impulse el crecimiento y éxito de nuestros participantes.</span>
              </li>
              <li className="flex items-center space-x-3 rtl:space-x-reverse">
                  <svg className="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                  </svg>
                  <span>Contribuir al desarrollo de una fuerza laboral altamente calificada y comprometida, que impulse el progreso de la comunidad.</span>
              </li>
