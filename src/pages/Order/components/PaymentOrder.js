...
export const PaymentOrder = ({ setIsValid }) => {
	...
	const handleSubmit = (event) => {
		...
		const cliente = {
			...
			id: refIdentificacion.current.value,
			directionMain: refDireccionPrincipal.current.value,
			directionSec: refDireccionSecundaria.current.value,
		};

		setIsValid(true);
		dispatch(createOrder(cliente));
	};
	...
	return (
		<div className="flex flex-col h-full w-[95%] md:max-w-xl mt-12 md:mx-2">
			<div
				className=" bg-gray-200 border border-slate-900 rounded-lg p-3 dark:bg-slate-800"
				data-aos="fade-up"
			>
				<h1 className="text-center text-sm md:text-lg text-red-500 dark:text-red-400 underline underline-red-500">
					Para finalizar con tu compra!!
				</h1>
				<ul className="text-sm md:text-base text-start text-black list-disc list-inside leading-loose dark:text-white">
					<li>Rellena el formulario con tus datos para el envío.</li>
					<li>
						Asegúrate de colocar tu información correctamente para el envío.
					</li>
					<li>
						Los datos que proporciones no serán compartidos con ninguna otra
						persona o entidad.
					</li>
					<li>
						Una vez que llenes el formulario debes activar el recuadro que
					...
					<li>
						Luego de que realices el pago se te notificará con un mensaje de
						Whatsapp y se procederá a realizar el envío de tu pedido.
					</li>
					<li>
						Todos los pedidos son a domicilio y el costo del envío lo asumirá el
						comprador.
					</li>
...
<div className="flex flex-col h-full my-10 sm:my-[10%] md:mx-2">
