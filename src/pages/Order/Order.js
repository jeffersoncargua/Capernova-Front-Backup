  ...
  return (
    <div className="w-95% flex flex-wrap justify-around mx-auto mb-10 ">
       {showModal && <ModalError error={error} setShowModal={setShowModal} setHiddenPaypal={setHiddenPaypal} />}
        ...
        <div className="w-full md:w-[50%] flex flex-col items-center border-gray-300" data-aos="fade-up" >
        ...
        <div className="w-full md:w-[50%] flex flex-col items-center" data-aos="fade-up" >
