    ...
    <button disabled={isCompleted} className={`${isCompleted? 'hover:cursor-pointer':'hover:cursor-not-allowed'}`}>
      ...
      (<h1 className="w-full text-sm">¡Presiona la copa!</h1>)}
        ...
        <svg className="" viewBox="0 0 100 100">
          ...
          {/*<!-- Center text -->*/}
          <svg x='30' y='30' xmlns="http://www.w3.org/2000/svg" fill="currentColor" class={`bi bi-trophy-fill z-10 w-1 h-1 ${porcentaje === 100 ?'text-yellow-300':'text-gray-300'}`} viewBox="0 0 40 40">
