...
export const ProgressBar = ({porcentaje,isCompleted}) => {
  return (

    <button disabled={isCompleted} className={`${isCompleted? 'hover:cursor-pointer':'hover:cursor-not-allowed'}`}>
      <div className="relative w-28 h-28 block mb-2 flex flex-col justify-center items-center ">

      <h1 className="text-sm mb-2">Progreso</h1>
        ...
        <svg className="" viewBox="0 0 100 100">
          ...
          <svg x='30' y='30' xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={`bi bi-trophy z-10 w-1 h-1 ${porcentaje === 100 ?'text-yellow-300':'text-gray-300'} `} viewBox="0 0 40 40">
