				...
				<div className="relative w-full h-28 mb-2 flex flex-col justify-center items-center ">
					{matricula.notaFinal && (
						<div className=" mb-1">
							<h1 className="text-sm text-black dark:text-white">
								Nota Final: {matricula.notaFinal}
							</h1>
						</div>
					)}
					...
					{!(
						...
						<div data-tooltip-id="tooltip-progreso" className=" mb-1">
							...
							<Tooltip
								...
								place="top"
								content={
									"Para completar tu curso realiza las pruebas y deberes"
								}
							/>
						</div>
					) : (
						<div data-tooltip-id="tooltip-certificado" className=" mb-1">
							...
							<Tooltip
								id="tooltip-certificado"
								className="z-50"
								place="top"
								content={"Presiona la Copa"}
							/>
						</div>
					)}
					...
					<svg className="" viewBox="0 0 100 100">
						...
						<svg
							...
							fill="currentColor"
							className={`bi bi-trophy-fill z-10 w-1 h-1 ${matricula.estado === "Completado" && matricula.notaFinal !== null ? "text-yellow-300" : "text-gray-300"}`}
							viewBox="0 0 40 40"
						>
