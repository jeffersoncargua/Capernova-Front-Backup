...
export const SideBar = ({setShowPlayer, setShowLogro, setShowCourses, setShowDeberes, setShowPruebas,setShowInformacion,setShowDeberDetail,setShowPruebaDetail,setShowLibrary,setShowCursoLive,setResponse}) => {
  ...
  return (
    ...
    <div>
        ...
        <div id="drawer-navigation" className={`absolute top-0 left-0 z-40 w-[95%] min-[350px]:w-56 p-4 flex overflow-y-auto transition-transform ${showBar ? '-translate-x-full':''} sm:translate-x-0  bg-slate-800 dark:bg-gray-800 border-e-2 border border-b-2 rounded-lg border-slate-400 mt-4`} tabIndex="-1" aria-labelledby="drawer-navigation-label" >
            ...
            <div className="overflow-y-auto">
                ...
                <ul className="space-y-2 text-sm font-small">
                    ...
                    <li>
                        <button onClick={()=> {setResponse({});setShowCourses(false);setShowPlayer(false);setShowLogro(false);setShowDeberes(false);setShowPruebas(false);setShowInformacion(true);setShowDeberDetail(false);setShowPruebaDetail(false);setShowLibrary(false);setShowCursoLive(false)}} className="w-full flex items-center text-gray-300 p-2 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={() => {setResponse({});setShowCourses(true);setShowPlayer(false);setShowLogro(false);setShowDeberes(false);setShowPruebas(false);setShowInformacion(false);setShowDeberDetail(false);setShowPruebaDetail(false);setShowLibrary(false);setShowCursoLive(false)}} className="w-full flex items-center p-2 text-gray-300 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={() => {setResponse({});setShowCourses(false);setShowPlayer(false);setShowLogro(false);setShowDeberes(false);setShowPruebas(false);setShowInformacion(false);setShowDeberDetail(false);setShowPruebaDetail(false);setShowLibrary(true);setShowCursoLive(false)}} className="w-full flex items-center p-2 text-gray-300 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                            {/* <svg className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4H1m3 4H1m3 4H1m3 4H1m6.071.286a3.429 3.429 0 1 1 6.858 0M4 1h12a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Zm9 6.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/>
                            </svg> */}
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.424 34.424" fill="currentColor" className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" >
                                <g>
                                    <g>
                    ...
                    <li>
                        <button onClick={() => {setResponse({});setShowCourses(false);setShowPlayer(false);setShowLogro(false);setShowDeberes(false);setShowPruebas(false);setShowInformacion(false);setShowDeberDetail(false);setShowPruebaDetail(false);setShowLibrary(false);setShowCursoLive(true)}} className="w-full flex items-center p-2 text-gray-300 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                            {/* <svg className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4H1m3 4H1m3 4H1m3 4H1m6.071.286a3.429 3.429 0 1 1 6.858 0M4 1h12a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1Zm9 6.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z"/>
                            </svg> */}
                            <svg viewBox="0 -88 480 480" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                    ...
                    <li>
                        <button onClick={() => {setResponse({});setShowLogro(false);setShowPlayer(false);setShowCourses(false);setShowDeberes(true);setShowPruebas(false);setShowInformacion(false);setShowDeberDetail(false);setShowPruebaDetail(false);setShowLibrary(false);setShowCursoLive(false)}} className=" w-full flex items-center p-2 text-gray-300 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <button onClick={()=>{setResponse({});setShowLogro(true);setShowPlayer(false);setShowCourses(false);setShowDeberes(false);setShowPruebas(false);setShowInformacion(false);setShowDeberDetail(false);setShowPruebaDetail(false);setShowLibrary(false);setShowCursoLive(false)}} className=" w-full flex items-center p-2 text-gray-300 rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
