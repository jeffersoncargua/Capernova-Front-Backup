...
export const SideBar = ({setShowPlayer, setShowLogro, setShowCourses, setShowDeberes, setShowPruebas,setShowInformacion,setShowDeberDetail,setShowPruebaDetail}) => {
