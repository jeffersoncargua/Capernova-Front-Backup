...
export const ModalDownload = ({showModalDownload,setShowModalDownload, result, setResult}) => {
  ...
  return (
    <div>
        {/*<!-- Main modal -->*/}
        <div id="crud-modal" tabIndex="-1" className={`${showModalDownload? '':'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] h-full bg-gray-700/[0.6]`}>
            <div className="relative mx-auto p-4 w-full max-w-md max-h-full">
                ...
                <div className="relative my-[30%] bg-white rounded-lg shadow dark:bg-gray-700 mb-14">
                    ...
                    <div className="flex items-center justify-between p-4 md:p-5 dark:border-gray-600">
                        ...
                        <button onClick={()=>{setShowModalDownload(!showModalDownload);setResult({})}} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
