				...
				<div className="relative bg-white my-[20%] rounded-lg shadow dark:bg-gray-700">
					...
					<div className="p-4 md:p-5 text-center">
						<svg
							...
							height="16"
							fill="currentColor"
							className={`bi bi-check-circle mx-auto mb-4 text-green-400 w-12 h-12 dark:text-green-500`}
							viewBox="0 0 16 16"
						>
						...
						<ul className="max-w-md space-y-1 text-start text-black list-disc list-inside dark:text-white">
							...
							<li>
								Completar las pruebas, las mismas que están en el apartado
								izquierdo de tu pantalla.
							</li>
							<li>
								Dirigirte a la pestaña de <b>"Tu Progreso"</b> y presiona la
								copa para obtener tu certificado.
							</li>
						</ul>
