		...
		<div className="w-full md:max-w-xs mx-auto bg-white mb-8 flex flex-col items-center border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
			...
			<div className="w-full md:max-w-md">
				<img
					...
					alt="Aqui va la imagen del curso"
				/>
			</div>

			<div className="w-[95%] mx-auto flex flex-col justify-center items-center ">
				<h5 className="mb-2 text-md font-semibold tracking-tight text-center text-gray-900 dark:text-white">
				...
				<div className="w-full mb-2 flex flex-wrap justify-around">
					...
					<span
						className={`inline-flex items-center ${matricula.isActive ? "bg-green-100 dark:bg-green-900 dark:text-green-300 text-green-800" : "bg-red-100 dark:bg-red-900 dark:text-red-300 text-red-800"} text-xs font-medium px-2.5 py-0.5 rounded-full `}
					>
						<span
							className={`w-2 h-2 me-1 ${matricula.isActive ? "bg-green-500" : "bg-red-500"} rounded-full`}
						></span>
						{matricula.isActive ? "Activado" : "Deshabilitado"}
					</span>
					{/*Mostrar el estado de progreso */}
					<span
						className={`inline-flex items-center ${matricula.estado === "Completado" ? "bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-300 " : "bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300"} text-xs font-medium px-2.5 py-0.5 rounded-full `}
					>
						<span
							className={`w-2 h-2 me-1 ${matricula.estado === "Completado" ? "bg-orange-500" : "bg-blue-500"} rounded-full`}
						></span>
						{matricula.estado}
					</span>
				</div>
