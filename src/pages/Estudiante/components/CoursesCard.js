...
export const CoursesCard = ({matricula,curso,setCurso , children}) => {
  ...
  return (
    <div className="w-full md:max-w-xs mx-auto bg-white mb-8 flex flex-col items-center border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="w-full md:max-w-xs">
        <img className="rounded-t-lg " src={curso.imagenUrl} alt="Aqui va la imagen del curso" />
      </div>        
      
      <div className="w-[95%] mx-auto flex flex-col justify-center items-center ">
          <h5 className="mb-2 text-md font-semibold tracking-tight text-center text-gray-900 dark:text-white">{curso.titulo}</h5>
