                        ...
                        <tr key={matricula.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td className="px-4 py-3">
                                ...
                                (<div className="py-1 flex justify-start" >
                                    <Link to={matricula.curso.claseUrl} target="_blank" className="flex items-center justify-center py-2 px-4 text-sm text-gray-900 hover:text-white bg-green-300 hover:bg-green-400 rounded-lg mr-2">
