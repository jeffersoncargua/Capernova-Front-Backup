...
export const WhatsappComponent = () => {
  ...
  return (
    <div data-dial-init className="fixed start-14 bottom-14 group z-50">
        <div id="speed-dial-menu-hover" className={`flex flex-col items-center ${hidden ? 'hidden':''} mb-4 space-y-2`}>
            <div className="flex flex-col items-center justify-center max-w-xs p-6 bg-green-300 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">           
                ...
                <div>
                    <p className="mb-3 font-normal text-justify text-gray-900 dark:text-gray-400">Si necesitas ayuda para adquirir nuestros cursos, envíanos un mensaje a nuestro whatsapp:</p>
                    <a href={`https://api.whatsapp.com/send?phone=5939926491961`} target="blank" className="inline-flex font-medium items-center text-blue-500 hover:underline hover:text-white">
