        ...
        <div id="speed-dial-menu-hover" className={`flex flex-col items-center ${hidden ? 'hidden':''} mb-4 space-y-2`}>
            <div className="flex flex-col items-center justify-center max-w-xs p-6 bg-green-300 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">           
                ...
                <div>
                    ...
                    <a href="https://api.whatsapp.com/send?phone=593992649161" target="blank" className="inline-flex font-medium items-center text-blue-500 hover:underline hover:text-white">
