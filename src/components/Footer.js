      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul className="text-gray-500 dark:text-gray-400 font-medium">
                        ...
                        <li>
                            <Link to='https://www.instagram.com/capernova.edu_ec/profilecard/?igsh=eDVuM3l1dGg1Y2J5' target='blank' className="hover:underline">Instagram</Link>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <Link to='https://www.instagram.com/capernova.edu_ec/profilecard/?igsh=eDVuM3l1dGg1Y2J5' target='_blank' className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
