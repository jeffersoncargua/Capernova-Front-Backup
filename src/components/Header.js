  ...
  return (
    <header className='border-b-[1px] border-slate-400 rounded-lg dark:bg-gray-900'>
        ...
        <div className='py-[30px] flex justify-center'>
            <Link onClick={() => setShowDrop(true)}  to="/" className="flex items-center justify-center space-x-3 rtl:space-x-reverse h-[160px] w-[429px]">
        ...
        <nav className=" w-[95%] bg-white border-gray-200 dark:bg-gray-900 mx-auto">
            ...
            <div className="flex flex-wrap md:flex-nowrap items-center md:justify-between mx-auto p-4 justify-end">
                ...
                <div className="flex md:order-2  md:w-80">
                    ...
                    <button onClick={()=> {setHidden(!hidden);setShowDrop(true)} } data-collapse-toggle="navbar-search" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
                ...
                <div className='items-center md:order-3 hidden md:flex justify-between'>    
                    ...
                    {isAuth ? 
                    (<button onClick={() => {handleLogout();setShowDrop(true)}} className="block py-[10px] flex items-center px-3 mx-2 rounded bg-blue-600 hover:bg-blue-700 md:hover:text-gray-50 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                    ...
                    (<div className='flex items-center'>
                        <Link onClick={() =>setShowDrop(true)} to="register"  className="block py-2 px-3 mx-2 text-gray-900 rounded hover:bg-gray-100 hover:underline md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Register</Link>
                        <Link onClick={() =>setShowDrop(true)} to="login" className="block py-[10px] flex items-center px-3 mx-2 rounded bg-blue-600 hover:bg-blue-700 md:hover:text-gray-50 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                ...
                <div className={`${hidden ? 'hidden' :''} items-center justify-between w-full md:flex md:w-auto md:order-1 md:mr-4 flex-none`} id="navbar-search" >
                    ...
                    <ul className="flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li >
                            <Link onClick={() => {setHidden(!hidden);setShowDrop(true)}} to="/" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Home</Link>
                        </li>
                        <li>
                        ...
                        {user.role === 'Admin' && <li>
                            <Link onClick={() => {setHidden(!hidden);;setShowDrop(true)}} to="admin" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Administración</Link>
                        </li>}
                        {user.role === 'Teacher' && <li>
                            <Link onClick={() => {setHidden(!hidden);;setShowDrop(true)}} to="teacher" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Profesor</Link>
                        </li>}
                        {user.role === 'Secretary' && <li>
                            <Link onClick={() => {setHidden(!hidden);;setShowDrop(true)}} to="secretary" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Secretaria</Link>
                        </li>}
                        ...
                        (<li className='md:hidden'>
                            <button onClick={() => {handleLogout();setShowDrop(true)}} className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Logout</button>
                        </li>)
                        :
                        (<>
                            <li className='md:hidden'>
                                <Link onClick={() => {setHidden(true);setShowDrop(true)}} to="register" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Registrarse</Link>
                            </li>
                            <li className='md:hidden'>
                                <Link onClick={() => {setHidden(true);setShowDrop(true)}} to="login" className=" block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Sign In</Link>
                            </li>
                        </>)}
                    </ul>
                </div>
