        ...
        <nav className=" w-[95%] bg-white border-gray-200 dark:bg-gray-900 mx-auto">
            ...
            <div className="flex flex-wrap min-[880px]:flex-nowrap items-center min-[880px]:justify-between mx-auto p-4 justify-end">
                ...
                <div className="flex min-[880px]:order-2  min-[880px]:w-80">
                    <button onClick={() => setDarkMode(!darkMode)}  id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button" className="block min-[880px]:hidden  text-gray-500 inline-flex items-center justify-center dark:text-gray-400  w-10 h-10 rounded-lg text-sm p-2.5 ">
                        {darkMode ? (<svg id="theme-toggle-dark-icon" className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                            <path d="M17.8 13.75a1 1 0 0 0-.859-.5A7.488 7.488 0 0 1 10.52 2a1 1 0 0 0 0-.969A1.035 1.035 0 0 0 9.687.5h-.113a9.5 9.5 0 1 0 8.222 14.247 1 1 0 0 0 .004-.997Z"></path>
                        </svg>)                 
                        :                     
                        (<svg id="theme-toggle-light-icon" className="w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    {/*<button onClick={()=> setHidden(!hidden) }  type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" className="min-[880px]:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1">
                    ...
                    <button onClick={()=> {setHidden(!hidden);setShowDrop(true);setShowDropProductos(true)} } data-collapse-toggle="navbar-search" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg min-[880px]:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
                ...
                <div className='items-center min-[880px]:order-3 hidden min-[880px]:flex justify-between'>    
                    <button onClick={() => {setDarkMode(!darkMode);setShowDrop(true);setShowDropProductos(true)}}  id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button" className="text-gray-500 inline-flex items-center justify-center dark:text-gray-400  w-10 h-10   rounded-lg text-sm p-2 ">
                        {darkMode ? (<svg id="theme-toggle-dark-icon" className="w-6 h-6 hover:text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                            <path d="M17.8 13.75a1 1 0 0 0-.859-.5A7.488 7.488 0 0 1 10.52 2a1 1 0 0 0 0-.969A1.035 1.035 0 0 0 9.687.5h-.113a9.5 9.5 0 1 0 8.222 14.247 1 1 0 0 0 .004-.997Z"></path>
                        </svg>)                 
                        :                     
                        (<svg id="theme-toggle-light-icon" className="w-6 h-6 hover:text-blue-700 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M10 15a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm0-11a1 1 0 0 0 1-1V1a1 1 0 0 0-2 0v2a1 1 0 0 0 1 1Zm0 12a1 1 0 0 0-1 1v2a1 1 0 1 0 2 0v-2a1 1 0 0 0-1-1ZM4.343 5.757a1 1 0 0 0 1.414-1.414L4.343 2.929a1 1 0 0 0-1.414 1.414l1.414 1.414Zm11.314 8.486a1 1 0 0 0-1.414 1.414l1.414 1.414a1 1 0 0 0 1.414-1.414l-1.414-1.414ZM4 10a1 1 0 0 0-1-1H1a1 1 0 0 0 0 2h2a1 1 0 0 0 1-1Zm15-1h-2a1 1 0 1 0 0 2h2a1 1 0 0 0 0-2ZM4.343 14.243l-1.414 1.414a1 1 0 1 0 1.414 1.414l1.414-1.414a1 1 0 0 0-1.414-1.414ZM14.95 6.05a1 1 0 0 0 .707-.293l1.414-1.414a1 1 0 1 0-1.414-1.414l-1.414 1.414a1 1 0 0 0 .707 1.707Z"></path>
                        </svg>)
                        }                        
                    </button>        
                    ...
                    {isAuth ? 
                    (<button onClick={() => {handleLogout();setShowDrop(true);setShowDropProductos(true)}} className="block py-[10px] flex items-center px-3 mx-2 rounded bg-blue-600 hover:bg-blue-700 min-[880px]:hover:text-gray-50 dark:text-white min-[880px]:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">
                    ...
                    (<div className='flex items-center'>
                        <Link onClick={() =>{setShowDrop(true);setShowDropProductos(true)}} to="register"  className="block py-2 px-3 mx-2 text-gray-900 rounded hover:bg-gray-100 hover:underline min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 dark:text-white min-[880px]:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Registrarse</Link>
                        <Link onClick={() =>{setShowDrop(true);setShowDropProductos(true)}} to="login" className="block py-[10px] flex items-center px-3 mx-2 rounded bg-blue-600 hover:bg-blue-700 min-[880px]:hover:text-gray-50 dark:text-white min-[880px]:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">
                ...
                <div className={`${hidden ? 'hidden' :''} items-center justify-between w-full min-[880px]:flex min-[880px]:w-auto min-[880px]:order-1 min-[880px]:mr-4 flex-none`} id="navbar-search" >
                    {/*<div className="relative min-[880px]:hidden">
                    ...
                    <ul className="flex flex-col p-4 min-[880px]:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 min-[880px]:space-x-6 rtl:space-x-reverse min-[880px]:flex-row min-[880px]:mt-0 min-[880px]:border-0 min-[880px]:bg-white dark:bg-gray-800 min-[880px]:dark:bg-gray-900 dark:border-gray-700">
                        <li >
                            <Link onClick={() => {setHidden(!hidden);setShowDrop(true);setShowDropProductos(true)}} to="/" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 min-[880px]:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Inicio</Link>
                        </li>
                        <li>
                            <Link onClick={() => {setHidden(!hidden);setShowDrop(true);;setShowDropProductos(true)}} to="/nosotros" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 min-[880px]:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Nosotros</Link>
                        </li>
                        <li >
                            {/*<Link onClick={() => {setHidden(!hidden)}} to="products" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 min-[880px]:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Cursos</Link>*/}
                            <button onClick={() => {setShowDrop(!showDrop);setShowDropProductos(true)}} id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" className="flex items-center justify-between w-full py-2 px-3 text-gray-900 hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:border-0 min-[880px]:hover:text-blue-700 min-[880px]:p-0 min-[880px]:w-auto dark:text-white min-[880px]:dark:hover:text-blue-500 dark:focus:text-white dark:hover:bg-gray-700 min-[880px]:dark:hover:bg-transparent">
                             Cursos 
                            ...
                            <div id="dropdownNavbar" className={`${showDrop ? 'hidden':''} min-[880px]:absolute z-50 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow min-[880px]:w-44 dark:bg-gray-700 dark:divide-gray-600`} >
                                <DropDownCursos setShowDrop={setShowDrop} setHidden={setHidden} setShowDropProductos={setShowDropProductos} hidden={hidden} />
                        ...
                        <li >
                            ...
                            <div id="dropdownNavbar" className={`${showDropProductos ? 'hidden':''} min-[880px]:absolute z-50 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow min-[880px]:w-44 dark:bg-gray-700 dark:divide-gray-600`} >
                                <DropDownProductos setShowDrop={setShowDrop} setHidden={setHidden} setShowDropProductos={setShowDropProductos} hidden={hidden} />
                            </div>
                        </li>
                        ...
                        {user.role === 'Admin' && <li>
                            <Link onClick={() => {setHidden(!hidden);setShowDrop(true);setShowDropProductos(true)}} to="admin" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 min-[880px]:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Administración</Link>
                        </li>}
                        {user.role === 'Teacher' && <li>
                            <Link onClick={() => {setHidden(!hidden);setShowDrop(true);setShowDropProductos(true)}} to="teacher" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 min-[880px]:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Profesor</Link>
                        </li>}
                        {user.role === 'Secretary' && <li>
                            <Link onClick={() => {setHidden(!hidden);setShowDrop(true);setShowDropProductos(true)}} to="secretary" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 min-[880px]:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Secretaria</Link>
                        </li>}
                        {user.role === 'Student' && <li>
                            <Link onClick={() => {setHidden(!hidden);setShowDrop(true);setShowDropProductos(true)}} to="student" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 min-[880px]:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Mis Cursos</Link>
                        </li>}
                        {isAuth? 
                        (<li className='min-[880px]:hidden'>
                            <button onClick={() => {handleLogout();setShowDrop(true);setShowDropProductos(true)}} className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 dark:text-white min-[880px]:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Logout</button>
                        </li>)
                        :
                        (<>
                            <li className='min-[880px]:hidden'>
                                <Link onClick={() => {setHidden(true);setShowDrop(true);setShowDropProductos(true)}} to="register" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 dark:text-white min-[880px]:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Registrarse</Link>
                            </li>
                            <li className='min-[880px]:hidden'>
                                <Link onClick={() => {setHidden(true);setShowDrop(true);setShowDropProductos(true)}} to="login" className=" block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 min-[880px]:hover:bg-transparent min-[880px]:hover:text-blue-700 min-[880px]:p-0 dark:text-white min-[880px]:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white min-[880px]:dark:hover:bg-transparent dark:border-gray-700">Iniciar Sesión</Link>
                            </li>
                        </>)}
                    </ul>
                </div>
