		...
		<div className="w-[95%] mx-auto">
			...
			<div className="flex flex-wrap">
				<div className="w-1/2 md:w-1/4 my-3">
					<div className="w-[85%] mx-auto border border-gray-300 rounded-lg flex flex-col items-center justify-center py-3 gap-y-3 bg-gradient-to-r from-cyan-300 to-blue-400">
						...
						<svg
							...
							height="50"
							fill="currentColor"
							className="bi bi-clock-history text-slate-600 "
							viewBox="0 0 16 16"
						>
					...
					<div className="w-[85%] mx-auto border border-gray-300 rounded-lg flex flex-col items-center justify-center py-3 gap-y-3 bg-gradient-to-r from-cyan-300 to-blue-400">
						...
						<div className="flex items-center">
							<svg
								...
								height="20"
								fill="currentColor"
								className="bi bi-phone-fill text-slate-600 "
								viewBox="0 0 16 16"
							>
							...
							<svg
								...
								height="50"
								fill="currentColor"
								className="bi bi-laptop-fill text-slate-600 "
								viewBox="0 0 16 16"
							>
							...
							<svg
								...
								height="30"
								fill="currentColor"
								className="bi bi-tablet-fill text-slate-600"
								viewBox="0 0 16 16"
							>
				...
				<div className="w-1/2 md:w-1/4 my-3">
					<div className="w-[85%] mx-auto border border-gray-300 rounded-lg flex flex-col items-center justify-center py-3 gap-y-3 bg-gradient-to-r from-cyan-300 to-blue-400">
						<h4 className="font-medium text-2xs text-center ">
							Personal Capacitado
						</h4>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							...
							height="50"
							fill="currentColor"
							className="bi bi-person-fill-check text-slate-600"
							viewBox="0 0 16 16"
						>
				...
				<div className="w-1/2 md:w-1/4 my-3">
					<div className="w-[85%] mx-auto border border-gray-300 rounded-lg flex flex-col items-center justify-center py-3 gap-y-3 bg-gradient-to-r from-cyan-300 to-blue-400">
						...
						<svg
							...
							height="50"
							fill="currentColor"
							className="bi bi-mortarboard-fill text-slate-600"
							viewBox="0 0 16 16"
						>
