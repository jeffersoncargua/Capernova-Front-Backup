...
export const Products = () => {
	...
	const slices = [
		{
			imagen: "https://i.postimg.cc/wjFMLyF7/fondo5.png",
			title: "Titulo 5",
			description:
				"Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, dolor sequi officiis illum distinctio in eos voluptatum omnis qui cumque molestiae tempore ex eligendi ipsam ad aut minus! Sequi, molestiae!",
		},
		{
			imagen: "https://i.postimg.cc/bNcZhjsN/fondo2.jpg",
			title: "Titulo 1",
			description:
				"Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, sint!",
		},
		{
			imagen: "https://i.postimg.cc/BnJtjcTr/fondo3.jpg",
			title: "Titulo 2",
			description:
				"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quae eum perferendis quasi maiores tenetur totam!",
		},
		{
			imagen: "https://i.postimg.cc/hPLf43d8/fondo4.jpg",
			title: "Titulo 3",
			description:
				"Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum sunt quis iure blanditiis autem consequatur illo dicta perspiciatis doloribus officia.",
		},
		{
			imagen: "https://i.postimg.cc/wjFMLyF7/fondo5.png",
			title: "Titulo 4",
			description:
				"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nesciunt animi velit incidunt, vel facere placeat repudiandae. Recusandae omnis sint officia autem numquam assumenda sit odio?",
		},
		{
			imagen: "https://i.postimg.cc/wjFMLyF7/fondo5.png",
			title: "Titulo 5",
	...
	return (
		<div className="relative flex flex-col w-[95%] mx-auto">
			<h1 className="self-center text-5xl font-extrabold before:block before:absolute before:-inset-1 before:bg-cyan-400 relative my-8">
				<span className=" text-white relative ">Nuestros Cursos</span>
			</h1>
			...
			<div className="w-full static overflow-x-hidden rounded-lg">
				...
				<div
					className={`w-[95%] lg:flex  transition ease-in-out duration-40 ml-[31px]  hidden mx-auto `}
					style={{ transform: `translateX(-${current * 25}%)` }}
				>
					{slices.map((itemProd) => (
						<div className="shrink-0 w-full lg:w-1/4" key={itemProd}>
							{/*ProductCard */}
				...
				<div
					className={`w-[95%] md:flex  transition ease-in-out duration-40 ml-[31px]  lg:hidden `}
					style={{ transform: `translateX(-${current * 50}%)` }}
				>
					{slices.map((itemProd) => (
						<div className="shrink-0 w-full md:w-1/2" key={itemProd}>
							{/*ProductCard */}
							<ProductCard itemProd={itemProd} />
						</div>
					))}
				...
				<div
					className={`flex transition sm:hidden ease-in-out duration-40 mx-auto`}
					style={{ transform: `translateX(-${current * 100}%)` }}
				>
					{slices.map((itemProd) => (
						<div className="shrink-0 sm:w-full" key={itemProd}>
							{/*ProductCard */}
							<ProductCard itemProd={itemProd} />
						</div>
					))}
